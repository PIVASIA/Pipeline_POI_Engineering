...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "vintext_val": ("vintext/test_image", "vintext/test.json"),
    "fimotext_train":("fimotext/train_images", "fimotext/train.json"),
    "fimotext_val":("fimotext/val_images", "fimotext/valid.json")
}
